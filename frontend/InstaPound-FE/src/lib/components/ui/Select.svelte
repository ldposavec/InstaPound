...
<div class="w-full">
	...
	<select
		...
		{required}
		{onchange}
		class="w-full appearance-none rounded-lg border bg-white px-4 py-2.5 pr-10 text-slate-900 transition-all duration-200 focus:outline-none focus:ring-2 disabled:cursor-not-allowed disabled:bg-slate-50 disabled:text-slate-500 dark:bg-slate-900 dark:text-slate-100
		{error
